...
public class Juego4 extends Activity {
    ...
    @Override public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.juego4);
    ...
    public void lanzarRuleta(View view){
        ...
        AnimationDrawable animacion = (AnimationDrawable)getResources().getDrawable(R.drawable.animaciontropic2);
		...
		animation.setAnimationListener(new Animation.AnimationListener() {
            ...
            public void onAnimationEnd(Animation animation) {
            	...
            	if(seleccion<=30){
            	 ...
            	 Intent i = new Intent(Juego4.this, PantallaResultado2.class);
